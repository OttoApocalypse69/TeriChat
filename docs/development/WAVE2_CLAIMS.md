...
|---|---|---|
| W2-SESSIONS | Session worker: `apps/server/src/session_management.rs`, session handoff | Bounded own-session inventory; individual idempotent revocation; cross-account denial; HTTP/DB tests |
...
No frontend, auth-policy, crypto, manifests, migrations, deploy or CI changes
